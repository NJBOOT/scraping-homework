$(document).ready(function () {
    ...
    $.getJSON("/articles", function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            newDiv.append("<p class='article'>" + data[i].title +
                "<span><button data-id=" + data[i]._id + " class='save-article'> Save</button></span><span><button data-id=" + data[i]._id + " class='note'>Create Note</button></span><br/>"
                + data[i].link + "</p>" + "<p>" + data[i].blurb + "</p>")
